    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "Date", "Description", "Name", "Venue" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 15, 10, 0, 0, 0, DateTimeKind.Utc), "Intro to modern web technologies", "Web Tech Seminar", "Auditorium A" },
                    { 2, new DateTime(2025, 8, 1, 14, 0, 0, 0, DateTimeKind.Utc), "Hands-on AI workshop", "AI Workshop", "Lab C" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "bob@example.com", "Bob The Builder" }
                });
